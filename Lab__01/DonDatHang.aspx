    ...
    <div class="khung">
        ...
        <table>
            <tr>
                ...
                <td><asp:TextBox ID="txtKhachHang" Width="300px" runat="server" /></td>
            </tr>
            <tr>
                <td class="label">Địa chỉ:</td>
                <td><asp:TextBox ID="txtDiaChi" Width="300px" runat="server" /></td>
            </tr>
            <tr>
                <td class="label">Mã số thuế:</td>
                <td><asp:TextBox ID="txtMaSoThue" Width="300px" runat="server" Height="21px" /></td>
            </tr>
        </table>
        ...
        <div class="col-left">
            ...
            <br /><br />
            Số lượng:
            <asp:TextBox ID="txtSoLuong" Width="60px" runat="server">1</asp:TextBox> cái
        ...
        <div class="col-right">
            ...
            <asp:ListBox ID="lstBanh" Width="250px" Height="120px" SelectionMode="Multiple" runat="server" />
        ...
        <br />
        <asp:Button ID="btnIn" CssClass="btn-green" Text="In đơn đặt hàng" runat="server" />
